...
const Location = () => {
  return (
    <div className=" min-h-screen flex items-center justify-center relative">
      {/* <div className="absolute z-20  left-0 bottom-35">
        <img
          src="/src/assets/lightning-1 1.svg"
          alt="Left Lightning"
          className="w-150 z-20"
        />
      </div>

      <div className="absolute z-20 right-0 bottom-48">
        <img
      ...
      <div className="flex flex-col items-center justify-center max-w-[1200px] p-2">
