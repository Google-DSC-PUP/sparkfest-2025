      ...
      <div className="max-w-[2000px] mx-auto relative">
        ...
        <div className="hidden xl:block mt-9">
          ...
          <div className="pl-13">
            <div className="flex items-center">
              ...
              <h1
                className="header2 text-grey-100"
            ...
            <p className="text-white body1 w-[1160px] pl-7">
              A 1-week hackathon that is designed to bring together students to
              tackle real-world challenges with innovative tech solutions.{" "}
            </p>
          </div>
          ...
          <div className="text-grey-100 pl-20 mt-10">
            ...
            <p className="w-[760px] body1">
              The hackathon aims to address challenges by developing innovative
              solutions aligned with the Sustainable Development Goals (SDGs).
            </p>
          </div>
        </div>
        ...
        <div className="hidden md:block xl:hidden mt-9 px-6">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-white body2 text-center mt-4 px-8">
              A 1-week hackathon that is designed to bring together students to
              tackle real-world challenges with innovative tech solutions.{" "}
            </p>
          </div>
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="flex justify-center items-center">
              <img
                src={sparkyLogo}
                alt=""
                className="w-[60px] h-[60px] scale-x-[-1]"
              />
              <h1 className="mobile-headers">
                SPARK
                <span className="text-yellow">F</span>
                <span className="text-blue">E</span>
                <span className="text-green">S</span>
