...
const FooterPage = () => {
  return (
    <footer className="h-auto bg-cover bg-center w-full lg:px-20 flex flex-col">
      <div className="lg:min-w-[1720px] max-w-[2500px] mx-auto flex justify-center flex-col">
