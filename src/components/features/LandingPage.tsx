  ...
  return (
    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden  bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700">
      <div className="relative z-10 flex w-full flex-col md:flex-row items-center justify-between px-4 md:px-8 py-6 gap-4 md:gap-0">
        {/* Left side with mascot - smaller on mobile, to the top */}
        ...
        <div className="flex w-full  md:w-2/3 flex-col items-center space-y-2 sm:space-y-3 md:space-y-4 text-white">
          ...
          <div className="flex items-center justify-center gap-4 ">
            <div className="flex h-80 px-4 items-center justify-center rounded-[64px] border-2 border-white/70 bg-white/10 text-[21.056rem] font-mono font-bold backdrop-blur-sm hover:bg-blue">
              0
            </div>
            <div className="flex h-80 px-4 items-center justify-center rounded-[64px] border-2 border-white/70 bg-white/10 text-[21.056rem] font-mono font-bold backdrop-blur-sm hover:bg-yellow">
              0
            </div>
          </div>
